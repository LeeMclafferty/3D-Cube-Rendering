...
private:
	...
	GLfloat doubleTriangleVerticies[42] =
	{
		// Triangle 1
		// Position		    //Color
		-1.0, +1.0, -0.5f,  0.0, 1.0, 0.0, 1.0, // Left
		 0.0, -1.0, -0.5f,  0.0, 1.0, 0.0, 1.0, // Bottom
		+1.0, +1.0, -0.5f,  0.0, 1.0, 0.0, 1.0, // Right

		// Triangle 2
		// Position		    //Color
		 0.0, +1.0, +0.5f,  0.7, 0.0, 1.0, 1.0, // Top
		-1.0, -1.0, +0.5f,  0.7, 0.0, 1.0, 1.0, // Left
		+1.0, -1.0, +0.5f,  0.7, 0.0, 1.0, 1.0, // Right
	};
